...
#define PrintLogs 0 // 1 -> Print logs, 0 -> Disable logs
#if PrintLogs
//#define NSLog(...)
#else
#define NSLog(...)
...
#define HEADER_CONTENT_TYPE_URL_Encoded @"application/x-www-form-urlencoded"
...
// Sync multiple users
#define SYNC_MULTIPLE_USERS @"app/user/multiple"
